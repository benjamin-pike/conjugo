...
function TranslationBars(props){
    return(
        <div className = {styles["translation-bars"]}>
            <div className = {styles["translation-bars__1"]} />
            <div className = {styles["translation-bars__2"]} style = {{opacity: props.frequency > 1 ? "100%" : "25%"}} />
            <div className = {styles["translation-bars__3"]} style = {{opacity: props.frequency > 2 ? "100%" : "25%"}} />
        </div>
    );
}
...
function Translation(props){
    ...
    return(
        <div className = {styles["translation"]}>
            ...
            <TranslationBars frequency = { frequency } />
